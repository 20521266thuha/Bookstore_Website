...
<html lang="en">
  <style>
    ...
    @media only screen and (max-width: 768px) {
      ...
      .main__content,
      .main__img--container {
        width: 100%; /* Make content and image full width */
        text-align: center; /* Center text */
      }

      .search-container {
        padding: 10px; /* Adjust padding for search container */
      }

      .category-section {
        padding-left: 10px; /* Adjust padding for category section */
      }
}
    ...
    <div class="main">
        <div class="main__container">
          <div class="main__content">
            <h1>MIA</h1>
            <h2>BOOK CORNER</h2>
            <p>Second-hand books with real reviews.</p>
            <button class="main__btn"><a href="#search">Start your book journey</a></button>
          </div>
          <div class="main__img--container">
            <img class="img-fluid" id="main__img" src="./Assets/Mia.png" />
          </div>
        </div>
    </div>
  ...
  <div class="category-section" style="background-color: beige; padding-left: 171px; padding-top: -2px;">
    ...
    ?>
      <div id="book_<?php echo $book->id; ?>" class="row6">
        <img class="img-fluid" src="./Assets/<?php echo $book->cover; ?>" alt="">
