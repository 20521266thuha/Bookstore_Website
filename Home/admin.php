...
<div class="ad_body" style="margin-left: 50px">
    <div class="ad_body_left">
        <div style="display: flex; justify-content:center">
            ...
            <a href="./php/all_book_check.php" name="see-all" class="btn btn-edit" style="flex: 1;background-color: lightpink;max-width: 83px;margin-right: 73px;margin-bottom: 6px;padding-bottom: 3px;padding-top: 3px">See All</a>
        </div>
